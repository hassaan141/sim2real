...
def run_simulator(sim: sim_utils.SimulationContext, entities: dict[str, DeformableObject], origins: torch.Tensor):
    ...
    # nodal means per-vertex / per-node data for a deformable object.

    # Rigid body:

    # one root pose controls the whole object

    # Deformable body:

    # many mesh nodes move independently

    # So nodal_state means the state of all deformable mesh nodes.
